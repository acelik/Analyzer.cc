...
void Analyzer::fill_Folder(string group, const int max) {
  if(group == "FillRun") {
    ...
    for(vec_iter it=goodParts[ePos]->begin(); it!=goodParts[ePos]->end(); it++) {
     ...
     //benim ekledigim kisim deltaphi acisi icin //deltaPhi angle between lepton ve MET.
     histAddVal((absnormPhi(part->smearP.at(*it).Phi()-theMETVector.Phi())), "MetDphi");
    ...
    histAddVal2(theMETVector.Pt(), sqrt((sumpxForMht * sumpxForMht) + (sumpyForMht * sumpyForMht)), "MetvsMHT");
    histAddVal2(theMETVector.Pt(), sumptForHt, "MetvsHT"); 
...
for(auto index : *goodParts[CUTS::eRElec2] ) {
histAddVal2(calculateLeptonMetMt(_Electron->smearP.at(index)), leaddijetmass, "mTvsLeadingMass");
histAddVal2(calculateLeptonMetMt(_Electron->smearP.at(index)), leaddijetdeltaEta, "mTvsLeadingDeltaEta");    
histAddVal2(calculateLeptonMetMt(_Electron->smearP.at(index)), leaddijetdeltaR, "mTvsLeadingDeltaR");
histAddVal2(calculateLeptonMetMt(_Electron->smearP.at(index)), leaddijetpt, "mTvsLeadingPt");
histAddVal2((absnormPhi(_Electron->smearP.at(index).Phi()-theMETVector.Phi())), leaddijetmass, "MetDphiVSLeadingMass");
histAddVal2((absnormPhi(_Electron->smearP.at(index).Phi()-theMETVector.Phi())), leaddijetdeltaEta, "MetDphiVSLeadingDeltaEta");
histAddVal2((absnormPhi(_Electron->smearP.at(index).Phi()-theMETVector.Phi())), leaddijetdeltaR, "MetDphiVSLeadingDeltaR");
histAddVal2((absnormPhi(_Electron->smearP.at(index).Phi()-theMETVector.Phi())), leaddijetpt, "MetDphiVSLeadingPt");
